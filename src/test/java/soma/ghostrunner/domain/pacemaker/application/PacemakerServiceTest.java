...
class PacemakerServiceTest {
    ...
    void 성공_흐름_오케스트레이션() throws Exception {
        ...
        InOrder inOrder = inOrder(memberService, courseService, vdotService, workoutService,
    ...
    void getPacemaker_completed_success() {
        ...
        verifyNoInteractions(llmService, vdotService, workoutService, memberService, redisRunningRepository);
    }
