...
class RunningApiMapperTest {
    ...
    void toCommandFromCreateCourseAndRunRequest() {
        ...
        Assertions.assertThat(command.startedAt()).isEqualTo(LocalDateTime.of(2025, 6, 20, 14, 5, 20));
    ...
    void toCommandFromRunOnCourseRequest() {
        ...
        Assertions.assertThat(soloCommand.startedAt()).isEqualTo(LocalDateTime.of(2025, 6, 20, 14, 5, 20));
        ...
        Assertions.assertThat(ghostCommand.startedAt()).isEqualTo(LocalDateTime.of(2025, 6, 20, 14, 5, 20));
